// Forked from bodhi.js until https://github.com/AcalaNetwork/bodhi.js/pull/556 is released then the import in index.ts can be reverted
...
const logger = new Logger('asdf');

type FrameSystemEventRecord = any;

const ETH_DECIMALS = 18;
const BIGNUMBER_ZERO = BigNumber.from(0);
const BIGNUMBER_ONE = BigNumber.from(1);
...
export const nativeToEthDecimal = (value: any, nativeDecimals = 12): BigNumber =>
